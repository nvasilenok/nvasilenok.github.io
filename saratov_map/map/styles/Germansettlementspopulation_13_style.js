...
var style_Germansettlementspopulation_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var bufferColor = "rgba(255,255,255,0.55)";
    ...
    if (value >= 220.000000 && value <= 2063.000000) {
        ...
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.3)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(18,179,0,1.0)'})}),
